...
$containerPadding = $is58mm ? '2px' : '0px';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        .qty { width: <?php echo $is58mm ? '6px' : '8px'; ?>; font-weight: bold; }
        .name { flex: 1; }
        .price { text-align: center; }
        .total { text-align: center; font-weight: bold; font-size: 1.2em; margin-top: 10px; }
